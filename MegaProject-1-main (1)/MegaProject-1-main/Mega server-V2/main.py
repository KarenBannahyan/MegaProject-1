...
def on_client_button_click():
    subprocess.Popen(['python', 'client-login.py'])

def on_tools_button_click():
...
tools_button = tk.Button(root, text="Tools", command=on_tools_button_click, **style)

server_button.place(relx=0.5, rely=0.3, anchor="center")
client_button.place(relx=0.5, rely=0.6, anchor="center")
tools_button.place(relx=0.5, rely=0.9, anchor="center")
